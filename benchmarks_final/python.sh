#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Sat 30 Aug 17:13:17 BST 2025      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 1 --mpi=pmix --mem-per-cpu=5120 nice -n 10 /mnt/users/kotssvasiliou/ALF_mod/pyalf/bin/python /mnt/users/kotssvasiliou/ED/benchmarks_final/runs.py 20 1 7.5
  echo ---------------                                           
