#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Sun  1 Jun 17:10:18 BST 2025      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 1 --mpi=pmix --mem-per-cpu=5120 nice -n 10 /mnt/users/kotssvasiliou/ALF_mod/pyalf/bin/python /mnt/users/kotssvasiliou/ED/benchmarks2/1d/ttranslation/tests.py Spin 10
  echo ---------------                                           
