'''
Benchmarking 1D Hubbard chain with
1) DQMC code for PBC fermions
2) Dumitru's SSE for PBC HC bosons
'''
import numpy as np
import time
...
def test_spinspin_correlator(params,parity=0):
    ...
    plt.savefig('/mnt/users/kotssvasiliou/ED/benchmarks2/1d/figures/spin_correlator.png',dpi=500)
    return
...
if __name__ == "__main__":
    params = {'L':4,'loc':0,'H_params':{'t':1,'mu':0,'U':2,'V':0.2},'diag_params':{'mode':'full'}}
    params['verbose'] = 1
    params['beta'] = 1
    params['sign'] = True
