#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Fri 30 May 10:33:00 BST 2025      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 1 --mpi=pmix --mem-per-cpu=2048 nice -n 10 /mnt/users/kotssvasiliou/ALF_mod/pyalf/bin/python /mnt/users/kotssvasiliou/ED/benchmarks2/2d/tests2.py
  echo ---------------                                           
