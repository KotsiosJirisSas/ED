#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Fri 31 Jan 15:45:55 GMT 2025      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 200 --mpi=pmix_v4 --mem-per-cpu=2048 nice -n 10 /usr/local/shared/bin/multirun 
  echo ---------------                                           
