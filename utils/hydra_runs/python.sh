#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Sat  5 Apr 21:48:12 BST 2025      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 1 --mpi=pmix_v4 --mem-per-cpu=1024 nice -n 10 /mnt/users/kotssvasiliou/ALF_mod/pyalf/bin/python /mnt/users/kotssvasiliou/ED/utils/ED_chains_final.py 15 14
  echo ---------------                                           
