#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Fri  4 Apr 07:32:53 BST 2025      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 1 --mpi=pmix_v4 --mem-per-cpu=1024 nice -n 10 /mnt/users/kotssvasiliou/ALF_mod/pyalf/bin/python ED_chains_final.py 13 13
  echo ---------------                                           
