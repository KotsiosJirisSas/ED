#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Sun 11 Jan 08:19:10 GMT 2026      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 1 --mpi=pmix --mem-per-cpu=2048 nice -n 10 /usr/bin/python gap_finder.py
  echo ---------------                                           
