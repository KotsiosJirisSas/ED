#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Fri 30 May 17:58:49 BST 2025      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 1 --mpi=pmix --mem-per-cpu=2048 nice -n 10 /mnt/users/kotssvasiliou/ALF_mod/pyalf/bin/python hubbard_chain.py Green_p
  echo ---------------                                           
